...
def distance(city1, city2):
    ...
    dist = sqrt((lat_city1-lat_city2)**2 + (lon_city1-lon_city2)**2)
    return dist
...
def closer_city(lat, lon, city1, city2):
    ...
    dist_to_1 = distance(city,city1)
    dist_to_2 = distance(city,city2)
...
def sprout_leaves(t, values):
    ...
    if is_leaf(t):
        ...
        branches_list = [sprout_leaves(b,values) for b in branches(t)]
...
def add_trees(t1, t2):
    ...
    if is_leaf(t1) and is_leaf(t2):
        ...
        alltrees = list(zip_longest(t1,t2,fillvalue = tree(0)))
        rt1,rt2 = alltrees[0]
        root = rt1 + rt2
        return tree(root,[add_trees(treepair[0],treepair[1]) for treepair in alltrees[1:]])
