...
def church_to_int(n):
    ...
    3
    """
    #丘奇数的意义就是high order function 的阶数，因此把嵌套的函数都跑一遍就可以计数出来了
    #传入参数为计数起点，用自增函数计数
    #或：要将丘奇数转成int类型，我们可以这么理解，由于丘奇数n是n阶函数，它接受函数f和参数x，意义是
    #对x应用n次f，我们可以这样，increment是自然数中的后继函数，自然数n 等于对0加n次1
